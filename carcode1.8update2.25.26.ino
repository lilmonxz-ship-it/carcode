...
const int AIN1 = 25, AIN2 = 26; //ซ้าย // ไว้แก้ pin ตอนประกอบด้วย //PWMA คือขาความเร็ว //AIN1/2 =ทิศทางในการับ (การจ่ายไฟ +,-)

const int BIN1 = 27, BIN2 = 14; //ขวา // ไว้แก้ pin ตอนประกอบด้วย //PWMB คือขาความเร็ว //BIN1/2 =ทิศทางในการับ (การจ่ายไฟ +,-)
...
const int servoPin = 18; // แก้แล้ว

const int servoPin1 = 19; // แก้แล้ว
